      ...
      >
        ...
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-2">
                  ...
                  <button
                    ...
                    className={`py-2 text-xs font-bold rounded-xl border-2 transition-all cursor-pointer ${
                      active
                        ...
                        : 'bg-white dark:bg-slate-800 text-slate-900 dark:text-white border-slate-200 dark:border-slate-700 hover:border-indigo-400 hover:text-indigo-600'
                    }`}
                  >
                    {preset}%
                  </button>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full py-2 pl-2.5 pr-6 text-xs font-bold text-slate-900 dark:text-white bg-white dark:bg-slate-800 border-2 rounded-xl focus:outline-none ${
                    customValue
            ...
            {slippage > 2.0 && !error && (
              <p className="mt-1.5 text-[11px] font-semibold text-amber-700 dark:text-amber-400 flex items-center gap-1">
